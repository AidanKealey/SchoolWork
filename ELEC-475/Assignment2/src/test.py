...
if __name__ == '__main__':
	...
	parser.add_argument('-style_image', type=str, help='style_dir image')
	...
	parser.add_argument('-alpha', type=float, default=1.0, help='Level of style_dir transfer, value between 0 and 1')
